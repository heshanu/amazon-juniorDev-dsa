...
//    }
    ...
    public boolean addContact(Contact contact){
        if(contactWithSameNumberExists(contact)){
            throw new IllegalArgumentException("Cannot add same item");
        }
        else{
            if(numberOfContacts<=MAX_CONTACTS){
                ...
                throw new IllegalArgumentException("cannit add");
            }
        }
    ...
    public boolean deleteContactByPhone(String phoneNumber) {
         ...
         *           you like to indicate the record was not found.
          **/
      throw new IllegalArgumentException("Recotd was not found");
