...
class ContactBookTest {
    ...
    public void testAddContact() {
       ...
       // contactBook
         ...
         **/
        assertEquals(contactBook.getNumberOfContacts()+1,currentNumOfContacts);
    }
    ...
    public void testSearchContactByPhone() {
        ...
        Contact searchPhone= contactBook.searchContactByPhone("184048 ");
        //assertNotNull(testContactForPhone);
        assertEquals(searchPhone.getPhoneNumber(),testContactForPhone.getPhoneNumber());
    ...
    public void testRemoveContactByPhone_found_returnsTrue() {
         ...
         **/
       // assertEquals(contactBook.searchContactByPhone(testContactForPhone.getPhoneNumber()),testContactForPhone.getPhoneNumber());
